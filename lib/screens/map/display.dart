  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('display').snapshots(),
        builder: (context, snapshot) {
          ...
          return MapPage(display: snapshot.data!.docs);
        },
      ),
    );
  }
...
class MapPage extends StatefulWidget {
  final List<DocumentSnapshot> display;
  ...
  Future<void> _createMarkers() async {
    ...
    try {
      QuerySnapshot locationSnapshot =
          await FirebaseFirestore.instance.collection('display').get();
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    Map<String, dynamic> data =
                        widget.display[index].data() as Map<String, dynamic>;
