...
class ParkFrame extends StatelessWidget {
  ...
  Future<List<dynamic>> fetchRestaurants() async {
    ...
    const apiUrl =
        'http://apis.data.go.kr/B551011/KorWithService1/searchKeyword1?serviceKey=$apiKey&MobileOS=ETC&MobileApp=AppTest&keyword=공원&numOfRows=20&pageNo=1&_type=json';
